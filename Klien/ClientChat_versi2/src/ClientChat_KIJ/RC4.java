...
public class RC4 
{
    ...
    private int[] sbox; //sbox
    private static final int SBOX_LENGTH = 256; //panjang sbox
    private static final int KEY_MIN_LENGTH = 5; //minimal key
	...
	{
        sbox = initSBox(key); //Memasukkan sejumlah key ke SBox
